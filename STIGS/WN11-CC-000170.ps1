<#
.SYNOPSIS
    This PowerShell script configures Windows 11 to allow Microsoft
...
try {
    ...
    if ($CurrentValue -eq $RequiredValue) {
        Write-Host ""
        Write-Host "WN11-CC-000170 remediation completed successfully."
    ...
    Write-Error "WN11-CC-000170 remediation failed: $($_.Exception.Message)"
    exit 1
}
